...
Trim3pInfoYsuSl::Trim3pInfoYsuSl(uint insert_end) : insert_end(insert_end), sid_match{}, umi_match{} {}

Trim3pYsuSl::Trim3pYsuSl(bool enable_partial, SeqMatcher sid_3p_matcher, SeqMatcher umi_sid_spacer_3p_matcher,
...
Trim3pInfoYsuSl Trim3pYsuSl::Trim(const uint8_t* seq2, size_t length, const char* seq, uint insert_start) const {
  Trim3pInfoYsuSl trim_info(static_cast<uint>(length));
...
bool Trim3pYsuSl::AbortTrim(const MatchInfo& match_info, uint insert_start) const {

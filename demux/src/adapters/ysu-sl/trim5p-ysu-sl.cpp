...
Trim5pYsuSl::Trim5pYsuSl(bool enable_partial, SeqMatcher runway_5p_matcher, SeqMatcher sid_5p_matcher,
...
Trim5pInfoYsuSl Trim5pYsuSl::Trim(const uint8_t* seq2, size_t length, const char* seq) const {
  uint current_pos{0};

  Trim5pInfoYsuSl trim_info;
...
bool Trim5pYsuSl::AbortTrim(const MatchInfo& match_info) const {

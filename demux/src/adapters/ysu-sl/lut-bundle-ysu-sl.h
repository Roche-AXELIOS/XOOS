...
/**
 * A bundle of LUT to be used in trimming YSU-SL data. These LUTs are meant
 * to be loaded from disk, but they might be created in memory for tests cases.
 */
class LutBundleYsuSl {
 public:
  LutBundleYsuSl(SeqMatcher runway_5p, SeqMatcher sid_5p, SeqMatcher sid_umi_spacer_5p, SeqMatcher umi_5p,
